...
fn test_py_implementation_random_arrays_conv2d_torch_transpose() {
    ...
    let target_output1: Array3<f32> = Array::from_shape_vec(
        ...
        vec![
            ...
            6.037546, 4.682065, 1.7877847, 1.1684452, 2.017402, 4.105599, 4.5629334, 3.5949254,
            2.758629, 0.6369324, 1.1169262, 1.4684255, 2.7736907, 2.9664128, 2.6813393, 1.4310664,
            0.4190872, 0.5252309, 0.9249734, 1.6928465, 2.0780373, 1.7369382, 1.3046416, 0.3887366,
        ],
    )
    .unwrap();
    ...
    let target_output2: Array3<f32> = Array::from_shape_vec(
        ...
        vec![
            ...
            8.574824, 6.400357, 3.328308, 1.7446139, 2.536149, 4.877659, 5.9356246, 7.020297,
    ...
    let target_output4: Array3<f32> = Array::from_shape_vec(
        ...
        vec![
            ...
            1.8651805, 1.8439271, 3.7875152, 5.2622232, 5.8000474, 4.2363214, 1.6259652, 1.0054839,
            2.7831144, 3.8394492, 3.6386461, 2.3359013, 0.78165007, 0.63158077, 1.4588236,
    ...
    let target_output5: Array3<f32> = Array::from_shape_vec(
        ...
        vec![
            ...
            3.5995946, 2.9142466, 2.1546159, 1.2690704, 1.0252702, 2.1070008, 3.5753164, 3.2298799,
            2.1234958, 1.7746001, 0.53583384, 1.9967595, 3.3339782, 3.5663772, 1.8189571, 1.448925,
            0.45935953, 1.5368297, 2.4519267, 2.8395061, 1.3719581, 0.85108393, 0.45722353,
    ...
    let target_output6: Array3<f32> = Array::from_shape_vec(
        ...
        vec![
            ...
            4.7649703, 3.0472074, 1.7904596, 1.4558735, 3.3807273, 4.693439, 3.8900793, 3.2032514,
            1.4674815, 1.8627332, 3.9013562, 5.3570285, 4.705308, 2.8398862, 1.0851057, 1.0122067,
            2.1739597, 3.9788904, 2.9729002, 1.6663357, 0.9921025, 0.56039816, 1.3762388,
    ...
    let target_output11: Array3<f32> = Array::from_shape_vec(
        ...
        vec![
            ...
            1.3176861, 3.0872867, 3.8708284, 2.6012692, 1.2530897, 1.1331078, 1.9586028, 3.3920135,
    ...
    let target_output12: Array3<f32> = Array::from_shape_vec(
        ...
        vec![
            ...
            1.1028432, 0.7865867, 0.1591172, 0.3942274, 0.4874617, 0.4022616, 0.36235812,
        ],
    )
    .unwrap();
    ...
    let target_output14: Array3<f32> = Array::from_shape_vec(
        ...
        vec![
            ...
            1.8356041, 4.083863, 4.233476, 4.7834864, 3.69611, 4.493311, 3.4800467, 2.3789911,
            1.1808037, 1.1687828, 2.7711892, 2.5664124, 3.1080046, 2.6559181, 2.2165222, 1.7084191,
    ...
    let target_output15: Array3<f32> = Array::from_shape_vec(
        ...
        vec![
            ...
            5.21172, 6.776279, 6.5082684, 6.798432, 6.065506, 3.8609574, 1.8272834, 0.8845324,
            2.4134095, 3.3390555, 5.0121307, 5.0036283, 5.4344096, 4.561091, 2.6668954, 0.9899533,
            0.76747304, 1.1809634, 1.636432, 2.3533666, 2.460103, 2.5692577, 1.7073956, 1.018367,
            0.23931447,
        ],
    )
    .unwrap();
    ...
    let target_output16: Array3<f32> = Array::from_shape_vec(
        ...
        vec![
            ...
            0.55494213, 1.0575575, 3.6816702, 2.9681506, 3.4333057, 3.718822, 3.8887475, 1.9480996,
            ...
            0.4596487, 0.7330724, 2.26362, 2.1269777, 2.4778764, 2.4989414, 2.2931244, 1.754318,
            0.36484304, 0.6525008, 0.62733936, 1.0571225, 0.3473795, 1.0103965, 0.9403165,
            0.64446837, 0.19241664,
        ],
    )
    .unwrap();
    ...
    let target_output17: Array3<f32> = Array::from_shape_vec(
        ...
        vec![
            ...
            2.639816, 1.6273787, 1.1863438, 2.959039, 5.701863, 5.071146, 4.2925, 5.0260577,
            2.660933, 2.0463526, 0.905205, 2.031211, 3.3807635, 3.5678267, 2.2897942, 2.7324352,
            1.7248006, 1.3060479, 0.5155197, 0.9724378, 1.1645548, 1.1497344, 1.0829911, 1.035286,
            0.7397711, 0.6584395,
        ],
    )
    .unwrap();
    ...
    let target_output18: Array3<f32> = Array::from_shape_vec(
        ...
        vec![
            ...
            1.2532284, 1.1808238, 1.9275321, 2.005684, 1.8192613, 1.710901, 2.27922, 0.9712485,
            0.5741586,
        ],
    )
    .unwrap();
